                            ...
                            <div class="col mx-auto">
                                <div class="auth-form-box">
                                    ...
                                    <form method="post" action="{{ route('auth.post') }}">
                                        ...
                                        <div class="col-md-8 offset-md-4"></div><button type="submit" name="submit_login" class="btn btn-primary w-100 mb-3">Đăng nhập</button> @if (Route::has('password.request'))
