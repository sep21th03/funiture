                              ...
                              <div class="col mx-auto">
                                  <div class="auth-form-box">
                                      ...
                                      <form method="POST" action="{{ route('auth.login.post') }}">
                                          ...
                                          </div><div class="col-md-8 offset-md-4"></div><button type="button" name="submit_login" class="btn btn-primary w-100 mb-3">Đăng nhập</button> @if (Route::has('password.request'))
